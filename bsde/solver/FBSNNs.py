...
class FBSNN(ABC):  # Forward-Backward Stochastic Neural Network
    ...
    def __init__(self, Xi, T,
        ...
        # tf session
        self.sess = tf.compat.v1.Session(config=tf.compat.v1.ConfigProto(allow_soft_placement=False,
    ...
    def train(self, N_Iter, learning_rate):
        ...
        for it in range(N_Iter):
            ...
            if it % 10 == 0:
                ...
                loss_value, Y0_value, learning_rate_value = self.sess.run([self.loss, self.Y0_pred, self.learning_rate],
                                                                          tf_dict)
